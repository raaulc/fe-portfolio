          ...
          <BlurFade delay={BLUR_FADE_DELAY * 16}>
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                Experienced in designing and shipping user-facing experiences across web and mobile platforms. Strong frontend focus with expertise in React, TypeScript, and JavaScript, while skilled at collaborating with backend/infra teams using Java, Spring, Kafka, MySQL, AWS, and Kubernetes. Open to discussing opportunities in frontend engineering, performance optimization, and real-time integrations. Let's connect to explore how I can contribute to your team's success.
              </p>
